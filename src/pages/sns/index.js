...
const SNS = () => {
  ...
  const SnsContentList1 =[
    ...
    {icon:SiDiscord, color:'#4E649C', title:"畳Discord", discription:"畳サーバーで遊ぶ際に参加が必要となるサーバーです。リンク先の利用規約をご確認の上、お楽しみください！", link: "https://discord.com/invite/t4YAKKxaq9"},
    ...
    <div>
        ...
        <div className={Style["sns-wrapper"]}>
          {SnsContentList1.map((item) => {
            return(
              <Link href={item.link} className={Style["sns-link"]}>
