  ...
  const QuestionList=[
    {
      ...
      answer:<>まずは指定のGoogleフォームで開発経験や希望する班をお聞きします。回答を送信するとDiscordへの招待リンクが届きますので入室してください。
                入室後 #面接の流れチャンネルをご確認の上、#面接日時決定チャンネルで面接希望日時を複数記入いただきます。面接は30分程度を予定しております。(複数班希望されると長くなりやすいです。)
                面接終了後、面接官同士で審議を行い合否通知をDiscord上でお出しします。※Googleフォームも上記の記事からご記入いただけます。</>,
    },
    {
      question:"まだ勉強中で力になれるかわかりません。",
      answer:<>開発力の詳細は面接でお聞きしますが、まったくの無知(初学者)でない限り、さほど問題にならないことが多いです。
    ...
    },
    {
      ...
      answer:<>2022年10月現在、毎週月曜日の22時から40分程度、進捗確認と方針決定のためのミーティングを開催しています。
    ...
    },
    {
      ...
      answer:<>お支払いしたいところですが、現状サーバーの維持だけで手一杯です。あくまでお手伝いのつもりで応募をお願いしたいです。
                お仕事のつもりで応募するのはおやめください。生活サーバーでのガチャ券プレゼントは検討中です。</>,
    },
    {
      question:"数か月後忙しくなるのがわかっています。どうしたらよいですか？", 
      answer:<>畳サーバーでは休職制度を設けています。2週間以上のお休みを希望する場合、「希望休職期間・理由」を報告いただければ一時お休みすることが可能です。
