    ...
    <div>
      ...
      <main>
        ...
        <div className='subtitle-content'>
          <Image className='subtitle-img' src={PleaseVote} alt="サブスクイメージ画像" />
          <p>
          JEの方は、1日1回
        ...
        <Subtitle subtitle="プロフィールカードを作ってみよう（＃畳サーバープロフィールカード)"/>
          <div className='subtitle-content'>
            <div className={Style["download-container"]}>
              <Image className='subtitle-img' src={PleaseProfile1} alt="プロフィールカード" />
            ...
            <Image className='subtitle-img' src={PleaseProfile2} alt="プロフィールカードお手本" />
            <p>
        ...
        <Subtitle subtitle="サーバー維持の為いろんな方と交流してみてください！"/>
          <div className='subtitle-content'>
            <Image className='subtitle-img' src={PleaseJoin} alt="交流している画像" />
            <p>
